...
class ChallanGenerator:
    def __init__(self, output_dir: Optional[str] = None):
        ...
        Args:
            output_dir (str, optional): Custom output directory. Defaults to 'challans_output' under the module directory.
        """
        base_dir = Path(__file__).parent.resolve()
        self.output_dir = Path(output_dir) if output_dir else base_dir / "challans_output"
